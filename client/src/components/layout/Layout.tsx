...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Mobile-friendly footer with reduced content on smaller screens */}
      <footer className="bg-gray-100 py-4 sm:py-6 safe-area-inset">
        <div className="container mx-auto px-4">
          {/* Mobile footer (simpler layout) */}
          <div className="md:hidden">
            <div className="text-center mb-4">
              <h3 className="font-bold text-lg mb-2">TradeBikes</h3>
              <p className="text-gray-600 text-sm">
                B2B platform for motorcycle trading
              </p>
            </div>
            
            <div className="flex justify-center space-x-4 mb-4">
              <Link href="/" className="text-gray-600 hover:text-primary text-sm">Home</Link>
              <Link href="/about" className="text-gray-600 hover:text-primary text-sm">About</Link>
          ...
          <div className="hidden md:grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-lg mb-4">TradeBikes</h3>
              <p className="text-gray-600 text-sm">
                The B2B platform for trading used motorcycles between dealerships and traders.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-2">Email: info@tradebikes.com</p>
              <p className="text-sm text-gray-600 mb-2">Phone: +44 (0) 000 000 0000</p>
          ...
          <div className="mt-4 md:mt-8 pt-4 md:pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
