    ...
    <Layout>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block mb-4 bg-primary/80 backdrop-blur-sm px-6 py-2 rounded-full shadow-lg">
              <p className="text-white font-medium tracking-wide uppercase text-sm">
                B2B Motorcycle Trading Platform
              </p>
            </div>

            <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
              Modernising{" "}
              <span className="text-accent">Motorcycle Trading</span>
            </h1>

            <div className="bg-black/40 backdrop-blur-sm p-6 rounded-2xl shadow-xl mb-8">
              <p className="text-xl text-white leading-relaxed">
                TradeBikes is the modern way to trade used motorcycles between
                dealerships and traders with real-time auctions.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/register">
                <Button
                  size="lg"
                  className="bg-white text-primary hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 text-lg px-8"
                >
                  Register Now
                </Button>
              </Link>
            ...
            <p className="mt-6 text-white text-sm bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full inline-block">
              Free 1-month trial • £125/month + VAT thereafter • No credit card
              required
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              Why Choose TradeBikes?
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our platform offers a streamlined approach to motorcycle trading
              with powerful features designed for dealers and traders.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="group relative bg-card p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-border overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mb-4">
                  Bid in real-time on available motorcycles with live updates
                  and instant notifications when you're outbid.
                </p>
                <Link
                  href="/auctions"
                  className="text-primary font-medium inline-flex items-center group-hover:translate-x-2 transition-transform duration-300"
                >
                  Learn more
                  <svg
            ...
            <div className="group relative bg-card p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-border overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mb-4">
                  Find available motorcycles based on your location and
                  preferred radius for convenient trading and logistics.
                </p>
                <Link
                  href="/map"
                  className="text-primary font-medium inline-flex items-center group-hover:translate-x-2 transition-transform duration-300"
            ...
            <div className="group relative bg-card p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-border overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-muted-foreground mb-4">
                  All motorcycles undergo verification checks to ensure quality
                  and accurate information for confident bidding.
                </p>
                <Link
                  href="/about"
                  className="text-primary font-medium inline-flex items-center group-hover:translate-x-2 transition-transform duration-300"
      ...
      <div className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Getting started with TradeBikes is simple. Follow these steps to
              begin trading motorcycles efficiently.
            </p>
          </div>
            ...
            <div className="flex-1 relative mb-16 md:mb-0">
              ...
              <div className="relative flex items-start mb-12">
                <div className="min-w-[80px] mr-6">
                  <div className="relative">
                    <div className="w-20 h-20 bg-gradient-to-br from-primary to-primary-dark text-white rounded-2xl shadow-lg flex items-center justify-center text-2xl font-bold">
                      1
                    </div>
                    {/* Connector line */}
                ...
                <div className="pt-2">
                  ...
                  <p className="text-muted-foreground">
                    Create your account and specify your role as a dealer or
                    trader. We'll verify your business details to ensure
                    platform security.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start mb-12">
                ...
                <div className="pt-2">
                  <h3 className="text-xl font-bold mb-3 text-foreground">
                    List or Bid on Motorcycles
                  </h3>
                  <p className="text-muted-foreground">
                    Dealers can list motorcycles with detailed information and
                    up to 20 high-quality photos. Traders can browse auctions
                    and place bids in real-time.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-muted-foreground">
                    Once an auction ends, both parties are notified and can
                    securely exchange payment and arrange delivery through our
            ...
            <div className="md:flex-1">
              <div className="bg-primary-dark rounded-2xl shadow-xl overflow-hidden relative h-[500px]">
                <div className="absolute inset-0 flex items-center justify-center">
                  <Bike
                    className="h-32 w-32 text-primary-foreground/10"
                    strokeWidth={1}
                  />
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">
                    Join hundreds of dealers and traders on TradeBikes
                  </h3>
                  <Link href="/register">
      ...
      <div className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              Built For Both Buyers & Sellers
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our platform offers tailored features for both sides of the
              motorcycle trading ecosystem.
            </p>
          </div>
                  ...
                  <ul className="space-y-4 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-foreground">
                        Easy motorcycle listing with up to 20 images per listing
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      ...
                      <span className="text-foreground">
                        Set flexible auction durations from 15 minutes to 24
                        hours
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-foreground">
                        Instant notifications for new bids and auction results
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      ...
                      <span className="text-foreground">
                        Comprehensive dashboard to manage all listings
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      ...
                      <span className="text-foreground">
                        Trader ratings to ensure quality transactions
                      </span>
                    </li>
                  </ul>
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-4 mb-8">
                    <li className="flex items-start">
                      ...
                      <span className="text-foreground">
                        Browse all available motorcycles with advanced filters
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0 w-6 h-6 bg-amber-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-foreground">
                        Location-based search to find motorcycles nearby
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0 w-6 h-6 bg-amber-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-foreground">
                        Rate dealers after completed transactions
                      </span>
                    </li>
                  </ul>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-[#1a3469] py-24">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            ...
            <path
              d="M320,50 Q400,350 200,450 T450,550"
              stroke="white"
              strokeWidth="10"
              fill="none"
            />
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready to Transform Your Motorcycle Trading?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join TradeBikes today and experience a faster, more efficient way
              to buy and sell used motorcycles.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <svg
                      className="h-5 w-5 text-amber-300 mr-2 flex-shrink-0"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col space-y-4">
                  <Link href="/register" className="w-full">
                    <Button
                      size="lg"
                      className="w-full bg-white text-primary hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      Start Free Trial
                    </Button>
                  </Link>
                  <Link href="/about" className="w-full">
                    <Button
                      size="lg"
                      variant="outline"
                      className="w-full text-white border-white hover:bg-white/10 transition-all duration-300"
                    >
                      Learn More
                    </Button>
                  </Link>
